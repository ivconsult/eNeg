...
namespace citPOINT.eNeg.MVVM.Test
{
    ...
    public class MockNegotiationModel : INegotiationModel
    {
        ...
        private eNegPaging mOnGoingNegotiationPager;
        private eNegPaging mClosedNegotiationPager;
        ...
        private List<Message> MessagesByConverationIDs(Guid?[] ConversationID)
        {
            ...
            foreach (Message msg in this.Messages)
            {
                ...
                if (Array.IndexOf(ConversationID, msg.ConversationID) != -1)
                {
        ...
        /// <summary>
        /// Get OnGoing Negotiation Pager
        /// </summary>
        /// <value></value>
        public eNegPaging OnGoingNegotiationPager
        {
            get
            {

                if (mOnGoingNegotiationPager == null)
                {
                    mOnGoingNegotiationPager = new eNegPaging();
                    mOnGoingNegotiationPager.CurrentPageNumber = 1;
                    mOnGoingNegotiationPager.ItemsCount = OngiongNegotiations.Count;
                    mOnGoingNegotiationPager.ItemsPagesCount = 3;
                    mOnGoingNegotiationPager.uxPagePanel = new System.Windows.Controls.StackPanel();
                }
                return mOnGoingNegotiationPager;
            }
        }

        /// <summary>
        /// Get Closed Negotiation Pager
        /// </summary>
        /// <value></value>
        public eNegPaging ClosedNegotiationPager
        {
            get
            {
                if (mClosedNegotiationPager == null)
                {
                    mClosedNegotiationPager = new eNegPaging();
                    mClosedNegotiationPager.CurrentPageNumber = 1;
                    mClosedNegotiationPager.ItemsCount = ClosedNegotiation.Count;
                    mClosedNegotiationPager.ItemsPagesCount = 3;
                    mClosedNegotiationPager.uxPagePanel = new System.Windows.Controls.StackPanel();
                }
                return mClosedNegotiationPager;
            }
        }
        ...
        /// <summary>
        /// GetClosedNegotiationCountComplete
        /// </summary>
        public event Action<InvokeOperation<int>> GetClosedNegotiationCountComplete;
        /// <summary>
        /// GetMessageComplete
        /// </summary>
        public event EventHandler<eNegEntityResultArgs<Message>> GetMessageComplete;
        /// <summary>
        /// Get Messages By Negotiations ID Async
        /// </summary>
        public event EventHandler<eNegEntityResultArgs<Message>> GetMessagesByNegotiationIDsComplete;
        /// <summary>
        /// GetNegotiationComplete
        /// </summary>
        public event EventHandler<eNegEntityResultArgs<Negotiation>> GetNegotiationComplete;
        /// <summary>
        /// GetOngoingNegotiationComplete
        /// </summary>
        public event EventHandler<eNegEntityResultArgs<Negotiation>> GetOngoingNegotiationComplete;
        /// <summary>
        /// GetClosedNegotiationComplete
        /// </summary>
        public event EventHandler<eNegEntityResultArgs<Negotiation>> GetClosedNegotiationComplete;
        /// <summary>
        ...
        /// </summary>
        public event EventHandler<eNegEntityResultArgs<citPOINT.eNeg.Data.Web.Application>> GetApplicationComplete;
        /// <summary>
        ...
        /// <summary>
        /// GetConversationComplete
        /// </summary>
        public event EventHandler<eNegEntityResultArgs<Conversation>> GetConversationComplete;
        public event EventHandler<eNegEntityResultArgs<Conversation>> GetConversationByNegIDComplete;
        /// <summary>
        /// GetOnGoingNegotiationCountComplete
        /// </summary>
        public event Action<InvokeOperation<int>> GetOnGoingNegotiationCountComplete;
        /// <summary>
        ...
        /// </summary>
        public void GetConversationAsync()
        {

            if (GetConversationComplete != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    GetConversationComplete(this, new eNegEntityResultArgs<Conversation>(mConversations));
                });
            }
        }

        /// <summary>
        /// Get Conversation By Negotiation IDs
        /// </summary>
        /// <param name="NegotiationIDs">Negotiation IDs</param>
        public void GetConversationByNegIDAsync(Guid[] NegotiationIDs)
        {
            if (GetConversationByNegIDComplete != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    GetConversationByNegIDComplete(this, new eNegEntityResultArgs<Conversation>(
                    ConversationsByNegIDs(NegotiationIDs)));
                });
            }
        }
        ...
        public void GetMessageAsync()
        {
            if (GetMessageComplete != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    GetMessageComplete(this, new eNegEntityResultArgs<Message>(this.Messages));
                });
            }
        }
        ...
        /// Get List of Messages
        /// </summary>
        /// <param name="Negotiations">Converation IDs</param>
        public void GetMessageByNegotiationsIDAsync(Guid[] Negotiations)
        {
            if (GetMessageComplete != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    List<Guid?> XNegotiations = new List<Guid?>();

                    foreach (var item in Negotiations)
                    {
                        XNegotiations.Add(item);
                    }

                    GetMessageComplete(this, new eNegEntityResultArgs<Message>(this.MessagesByConverationIDs(XNegotiations.ToArray())));
                });
            }
        }
        ...
        /// Get All Negotiation
        /// </summary>
        public void GetNegotiationAsync()
        {   //TODO:Review All Nego.
            if (GetNegotiationComplete != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    GetNegotiationComplete(this, new eNegEntityResultArgs<Negotiation>(this.OngiongNegotiations));
                });
            }
        }

        /// <summary>
        /// get Onging By Page Number
        /// </summary>
        /// <param name="PageNumber">Page Number</param>
        public void GetOnGoingNegotiationByPageNumberAsync(int PageNumber)
        {
            if (GetOngoingNegotiationComplete != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    GetOngoingNegotiationComplete(this, new eNegEntityResultArgs<Negotiation>(this.OngiongNegotiations));
                });
            }
        }

        /// <summary>
        /// Get Closed Negotiation
        /// </summary>
        /// <param name="PageNumber">Page Number</param>
        public void GetClosedNegotiationByPageNumberAsync(int PageNumber)
        {
            if (GetClosedNegotiationComplete != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    GetClosedNegotiationComplete(this, new eNegEntityResultArgs<Negotiation>(this.ClosedNegotiation));
                });
            }
        }

        /// <summary>
        /// get Onging record Count
        /// </summary>
        public void GetOnGoingNegotiationCountAsync()
        {
            if (GetOnGoingNegotiationCountComplete != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    //TODO: Review
                    GetOnGoingNegotiationCountComplete(Context.GetNegotiationCountByStatus(eNegConstant.NegotiationStatus.Ongoing, AppConfigurations.CurrentLoginUser.UserID));
                });
            }
        }

        /// <summary>
        /// get Closed Record Count
        /// </summary>
        public void GetClosedNegotiationCountAsync()
        {
            if (GetClosedNegotiationCountComplete != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                    {
                        //TODO: Review
                        GetClosedNegotiationCountComplete(Context.GetNegotiationCountByStatus(eNegConstant.NegotiationStatus.Closed, AppConfigurations.CurrentLoginUser.UserID));
                    });
            }
        }

        /// <summary>
        /// Gets the negotiation page number async.
        /// </summary>
        /// <param name="negotiationID">The negotiation ID.</param>
        /// <param name="statusID">The status ID.</param>
        /// <param name="userID">The user ID.</param>
        /// <param name="itemsPerPageCount">The items per page count.</param>
        public void GetNegotiationPageNumberAsync(Guid negotiationID, Guid statusID, Guid userID, int itemsPerPageCount)
        {

            if (GetNegotiationPageNumberComplete != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
                    //TODO: Review
                    GetNegotiationPageNumberComplete(Context.GetNegotiationPageNumber(negotiationID, statusID, userID, 5));
                });
            }
        }
        ...
        {
            if (GetNegotiationOrgaizationComplete != null)
            {
                Deployment.Current.Dispatcher.BeginInvoke(() =>
                {
