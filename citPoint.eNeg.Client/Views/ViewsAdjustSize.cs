...
namespace citPOINT.eNeg.Client
{
    ...
    public class ViewsAdjustSize
    {
        ...
        private double mMarginTopBottom = 10;
        private double mMargin = 10;
        private double mMarginLeftRight = 10;
        private double mBannerHeight = 124;
        ...
        /// <summary>
        /// Event Run after resize the user constrol and send Height and Width as args
        /// </summary>
        ...
        private void Content_Resized(object sender, EventArgs e)
        {
            ...
            if (App.Current.Host.Content.ActualHeight < MinHeight)
                ...
                // stretch the UserControl to the current brower Height - Title Height(122) - Menu Height(22)
