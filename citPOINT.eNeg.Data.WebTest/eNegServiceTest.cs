                    ...
                    mApplications = new List<Application>()
                       {
                           new Application ()
                            { 
                               ...
                               ApplicationBaseAddress="http://www.Monex314.com"
                            ...
                            { 
                               ...
                               ApplicationBaseAddress="http://www.Donapy485.com"
                            ...
                            { 
                               ...
                               ApplicationBaseAddress="http://www.Apps74.com"
...
")]
        ...
        void DeleteAllEntriesComplete(SubmitOperation subOp)
        {
            if (!subOp.HasError)
            {
                ...
                {
                    eNegMessageBox.ShowMessageBox(false, "DeleteAllEntriesComplete", "Number of Records deleted is not right.");
                }
                else
                {
