...
namespace citPOINT.eNeg.Data.Web
{
    ...
    public static class ServiceAuthentication
    {
        ...
        public static bool IsValid()
        {
            ...
            #region → Check on the incoming message to see whether the caller of this service is eNeg itself or is external caller
            var messageProperties = OperationContext.Current.IncomingMessageProperties;

            RemoteEndpointMessageProperty endpointProperty = messageProperties[RemoteEndpointMessageProperty.Name] as RemoteEndpointMessageProperty;
            #endregion

            #region → In case that the caller is eNeg           .
