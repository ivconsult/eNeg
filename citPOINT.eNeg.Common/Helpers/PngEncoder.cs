...
{
    /// <summary>
    /// Class that convert into Png image
    /// </summary>
    public class PngEncoder
    {
        ...
        /// <summary>
        /// Reprensent an object of RGB Color System
        /// </summary>
        ...
        /// <summary>
        /// Convert Array of bytes to memmory stream
        /// </summary>
        /// <param name="data">Array of bytes that we want to convert</param>
        ...
        /// <returns> CRC of the bytes buf[0..len-1].</returns>
        ...
        /// </summary>
        /// <param name="buf">value of buf</param>
        /// <returns> CRC of the bytes buf[0..len-1].</returns>
        ...
        /// <summary>
        /// Computes the adler32.
        /// </summary>
        /// <param name="buf">The buf.</param>
        /// <returns>uint of Adler32</returns>
