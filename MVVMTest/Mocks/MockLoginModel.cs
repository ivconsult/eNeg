...
namespace citPOINT.eNeg.MVVM.UnitTest
{
    ...
    public class MockLoginModel : ILogInModel
    {
        ...
        /// <summary>
        /// call back of get organization owned for user.
        /// </summary>
        public event Action<System.ServiceModel.DomainServices.Client.InvokeOperation<Guid>> GetOrganizationOwnedForUserComplete;
        ...
        public void LoginAsync(LoginParameters loginParameters)
        {
            ...
            {
                //LoginComplete(this, new LoginOperationEventArgs(new LoginOperation() { User = new LoginUser() { } }));
        ...
        /// <summary>
        /// Gets the organization owned for user async.
        /// </summary>
        /// <param name="userID">The user ID.</param>
        public void GetOrganizationOwnedForUserAsync(Guid userID)
        {
